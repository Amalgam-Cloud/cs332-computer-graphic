...
namespace Assignment8
{
    class Graphic
    {
        ...
        public Graphic(Graphics graphics, Matrix transformation, double width, double height, Vector pos)
        {
        ...
        private void Interpolate(Nodes a, Nodes b, double f, ref Nodes v)
        {
        ...
        public void DrawTriangle(Nodes a, Nodes b, Nodes c)
        {
            a = SpaceToScreen(a);
            b = SpaceToScreen(b);
            c = SpaceToScreen(c);
