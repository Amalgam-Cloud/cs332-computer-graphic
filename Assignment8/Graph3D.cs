...
namespace AffineTransformationsIn3D
{
    class Graph3D
    {
        ...
        public Graph3D(Graphics graphics, Matrix transformation, double width, double height, Vector pos)
        {
        ...
        private NodeNVectors SpaceToScreen(NodeNVectors vertex)
        {
            return new NodeNVectors(SpaceToScreenCoordinate(vertex.Coordinate), vertex.Normal, vertex.Color);
        }
        ...
        private void Interpolate(NodeNVectors a, NodeNVectors b, double f, ref NodeNVectors v)
        {
        ...
        public void DrawTriangle(NodeNVectors a, NodeNVectors b, NodeNVectors c)
        {
            a = SpaceToScreen(a);
            b = SpaceToScreen(b);
            c = SpaceToScreen(c);
            ...
            NodeNVectors left = new NodeNVectors();
            NodeNVectors right = new NodeNVectors();
            NodeNVectors point = new NodeNVectors();
